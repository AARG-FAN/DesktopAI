...
from PyQt5.QtCore import Qt, pyqtSignal, QObject, QPoint, QEvent, QSize, QFileSystemWatcher, QTimer, QPropertyAnimation, QEasingCurve
...
class KeyPressEater(QObject):
    ...
    def __init__(self, parent=None, skip_callback=None):
        super().__init__(parent)
...
class ChatDialog(QDialog):
    ...
    def scroll_to_bottom(self):
        ...
        QApplication.processEvents()  # 强制刷新界面，确保滚动生效
...
class MainWindow(QWidget):
    ...
    def select_role_dialog(self):
        ...
        if ok and role:
            ...
            # 将 voice_type 设置为固定值，例如 "BV700_V2_streaming"
            fixed_voice_type = "BV107_streaming"
            self.config["voice_type"] = fixed_voice_type
...
class DesktopAssistantApp(QApplication):
    def __init__(self, sys_argv):
        ...
        self.key_press_eater = KeyPressEater(skip_callback=self.assistant.skip_tts)
